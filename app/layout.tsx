...
export const metadata: Metadata = {
  title: "Joshua Arabejo — Aspiring Full-Stack Developer",
  description:
    "Aspiring Full-Stack Developer crafting modern, scalable, and user-focused digital experiences. BSIT student passionate about web applications, UI/UX, and clean architecture.",
  keywords: [
    "Joshua Arabejo",
